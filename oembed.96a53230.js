...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../javascript/webcomponents/oembed.js":[function(require,module,exports) {
...
customElements.define("oembed-element", /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(_class, [{
    ...
    value: function connectedCallback() {
      ...
      var urlAttr = this.getAttribute("url");
      ...
      if (urlAttr) {
        ...
        var discoverUrl = this.getAttribute("discover-url");
...
function renderOembed(shadow, urlToEmbed, options) {
  var apiUrlBuilder = new URL("https://cors-anywhere.herokuapp.com/".concat(urlToEmbed));
  ...
  httpGetAsync(apiUrl, function (rawResponse) {
    ...
    switch (response.type) {
      ...
      case "photo":
        ...
        if (options) {
          img.setAttribute("style", "max-width: ".concat(options.maxwidth, "px; max-height: ").concat(options.maxheight, "px;"));
        }
...
function tryRenderingHtml(shadow, response) {
  if (response && _typeof(response.html)) {
    var iframe = createIframe(response);
    shadow.appendChild(iframe);
    setTimeout(function () {
      var refetchedIframe = shadow.querySelector("iframe");
...
function getDiscoverUrl(url, callback) {
  var apiUrl = new URL("https://cors-anywhere.herokuapp.com/".concat(url)).toString();
  httpGetAsync(apiUrl, function (response) {
    var dom = document.createElement("html");
    dom.innerHTML = response;
    /** @type {HTMLLinkElement | null} */

    var oembedTag = dom.querySelector('link[type="application/json+oembed"]');
...
},{}]},{},["../../node_modules/parcel/src/builtins/hmr-runtime.js","../javascript/webcomponents/oembed.js"], null)
//# sourceMappingURL=/oembed.96a53230.js.map